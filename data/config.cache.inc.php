...
$cfg_basehost = 'http://beijingzhaoren.com';
$cfg_cmspath = '';
$cfg_cookie_encode = 'TQpwOgDdv5hfYGMuwFAFGAUWBbKL5';
$cfg_indexurl = '/';
$cfg_backup_dir = 'backupdata';
$cfg_indexname = '主页';
$cfg_webname = '北京明宇国际商务咨询公司_婚姻调查_财产调查_商业调查_竞争调查';
...
$cfg_multi_site = 'N';
$cfg_dede_log = 'N';
$cfg_powerby = 'Copyright &copy; 2002-2020 北京明宇国际商务咨询公司';
$cfg_arcsptitle = 'N';
$cfg_arcautosp = 'N';
...
$cfg_rewrite = 'N';
$cfg_delete = 'Y';
$cfg_keywords = '北京婚姻调查 婚姻调查 国际婚姻调查 国内婚姻调查 商务咨询 清收讨债 找孩子 ';
$cfg_description = '北京明宇国际商务咨询公司自成立以来一直致力于为个人客户、企事业单位处理各种应急、突发、棘手等各种调查工作和服务。专业提供：企业背景调查、竞争情报调查、网络诈骗调查、商业情报调查、打假维权调查、 复婚挽回帮助、婚姻调查取证等服务...... 主要包括：婚姻外遇调查，商务商业调查，财产资产调查。 工作中我们的认真、负责、实事求是、合理合法、规范的运作流程，以及滴水不漏的保密工作，受到了客户的高度信任和好评，在同行中有较高的声誉。';
$cfg_beian = '京ICP-10107173';
$cfg_need_typeid2 = 'Y';
$cfg_cache_type = 'id';
$cfg_max_face = 50;
$cfg_typedir_df = 'Y';
...
$cfg_dh = '+86 18801107173';
$cfg_dx = '18801107173';
$cfg_QQ = '3251484549';
$cfg_dz = '北京市朝阳区三里屯永利国际';
$cfg_cz = '010-18801107173';
$cfg_yx = '3251484549@qq.com';
$cfg_name = '北京明宇国际商务咨询有限公司';
$cfg_tb = '婚姻、商务、调查、处理一站式综合方案解决服务商';
?>