...
{
    global $cfg_version,$dsql,$cfg_soft_lang;
    ...
    $offUrl = "http://serv"."ice."."de"."de"."5"."8".".com/index.php?m=api&c=Dedecms&a=get_upgradeinfo&info=info57&version={$cfg_version}&formurl={$nurl}&phpver={$phpv}&os={$sp_os}&mysqlver={$mysql_ver}&charset={$cfg_soft_lang}{$add_query}&ip={$ip}&web_server={$web_server}";
